        ...
        <div className="bg-white/90 shadow-2xl backdrop-blur-sm border border-gray-100 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
            ...
            <div className="text-center pt-2">
              <button
                type="submit"
                className="w-full sm:w-auto px-8 sm:px-12 py-3 sm:py-4 bg-blue-600 text-white font-bold text-lg sm:text-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-blue-700"
              >
